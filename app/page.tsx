...
const APPS_SCRIPT_URL =
  'https://script.google.com/macros/s/PLACE_HOLDER_ID/exec';
  ...
  general: [
    {
      id: 'g1',
      category: 'General',
      question: 'Are all guardrails and toe boards in place and secure?',
    },
    {
      id: 'g2',
      category: 'Markings',
      question:
        'Rated load capacity clearly marked on both sides of the crane/hoist?',
    },
  ],
  lifting: [
    {
      ...
      category: 'Hooks',
      question:
        'Hooks inspected for cracks, deformation, or throat opening (not exceeding 15%)?',
    },
    {
      id: 'l2',
      category: 'Hooks',
      question: 'Hook safety latches present and functioning correctly?',
    },
    {
      id: 'l3',
      category: 'Wire Rope/Chain',
      question:
        'Is load medium free of kinking, crushing, bird-caging, or heat damage?',
    },
  ],
  equipment: {
    'Bridge Crane': [
      {
        id: 'e_b1',
        category: 'Bridge',
        question: 'Bridge rails and end stops secure and free of debris?',
      },
      {
        id: 'e_b2',
        category: 'Bridge',
        question:
          'Wheel bearings and gears lubricated with no excessive noise?',
      },
      {
        id: 'e_b3',
        category: 'Bridge',
        question: 'Bridge bumpers in good condition and properly attached?',
      },
    ],
    'Gantry Crane': [
      {
        ...
        category: 'Gantry',
        question:
          'Gantry legs and bracing free of structural damage or deformation?',
      },
      {
        id: 'e_g2',
        category: 'Gantry',
        question: 'Floor track or wheels clear of obstructions and functional?',
      },
      {
        id: 'e_g3',
        category: 'Gantry',
        question: 'Travel alarms and warning lights operational?',
      },
    ],
    'Jib Crane': [
      {
        id: 'e_j1',
        category: 'Jib',
        question: 'Mast/pillar base bolts tight and foundation secure?',
      },
      {
        id: 'e_j2',
        category: 'Jib',
        question: 'Boom rotates freely and smooth throughout entire arc?',
      },
      {
        id: 'e_j3',
        category: 'Jib',
        question: 'Tie-rod and support pins properly seated and pinned?',
      },
    ],
    Monorail: [
      {
        id: 'e_m1',
        category: 'Monorail',
        question: 'Monorail track hangars and supports secure and aligned?',
      },
      {
        id: 'e_m2',
        category: 'Monorail',
        question: 'Safety stops at open ends of the track present and secure?',
      },
      {
        id: 'e_m3',
        category: 'Monorail',
        question:
          'Switches and interlocks (if applicable) functioning properly?',
      },
    ],
  },
  attachment: {
    ...
    'Wire Rope Hoist': [
      {
        id: 'a_w1',
        category: 'Hoist Unit',
        question: 'Rope drum grooves inspected for wear or scoring?',
      },
      {
        id: 'a_w2',
        category: 'Hoist Unit',
        question: 'Rope guide/tensioner functioning to prevent overlapping?',
      },
      {
        id: 'a_w3',
        category: 'Hoist Unit',
        question: 'Dead end socket and rope clips secure?',
      },
    ],
    'Chain Hoist': [
      {
        id: 'a_c1',
        category: 'Hoist Unit',
        question: 'Load chain container/bag secure and not overfilled?',
      },
      {
        id: 'a_c2',
        category: 'Hoist Unit',
        question: 'Chain pockets in sheave free of debris and excessive wear?',
      },
      {
        id: 'a_c3',
        category: 'Hoist Unit',
        question: 'Slack chain end stop present and secure?',
      },
    ],
    'Trolley Unit': [
      {
        id: 'a_t1',
        category: 'Trolley',
        question: 'Trolley wheels show no signs of flat spots or flange wear?',
      },
      {
        id: 'a_t2',
        category: 'Trolley',
        question: 'Side plates and connecting pins show no signs of bending?',
      },
      {
        id: 'a_t3',
        category: 'Trolley',
        question: 'Drive pinion and gear mesh lubricated and aligned?',
      },
    ],
  },
  operation: {
    Electric: [
      {
        ...
        category: 'Electrical',
        question:
          'Pendant cable strain relief intact and controls clearly marked?',
      },
      {
        id: 'o_e2',
        category: 'Electrical',
        question: 'Emergency Stop button functions and cuts all power?',
      },
      {
        id: 'o_e3',
        category: 'Electrical',
        question: 'Limit switches (upper/lower) tested and stopping the hoist?',
      },
    ],
    Pneumatic: [
      {
        id: 'o_p1',
        category: 'Pneumatics',
        question: 'Air lines free of leaks, cracks, or loose fittings?',
      },
      {
        id: 'o_p2',
        category: 'Pneumatics',
        question:
          'Filter, Regulator, and Lubricator (FRL) units serviced and filled?',
      },
      {
        id: 'o_p3',
        category: 'Pneumatics',
        question: 'Exhaust mufflers in place and not obstructed?',
      },
    ],
    Manual: [
      {
        ...
        question: 'Hand chain/lever moves freely through all positions?',
      },
      {
        id: 'o_ma2',
        category: 'Manual Hoist',
        question: 'Load brake holds weight securely without slipping?',
      },
      {
        id: 'o_ma3',
        category: 'Manual Hoist',
        question: 'Ratchet and pawl mechanism engaging correctly?',
      },
    ],
  },
};
...
export default function App() {
  ...
  const currentQuestions = useMemo(() => {
    return [
      ...
      ...(CHECKLIST_DATABASE.equipment[
        equipmentType as keyof typeof CHECKLIST_DATABASE.equipment
      ] || []),
      ...(CHECKLIST_DATABASE.attachment[
        attachmentType as keyof typeof CHECKLIST_DATABASE.attachment
      ] || []),
      ...(CHECKLIST_DATABASE.operation[
        operationType as keyof typeof CHECKLIST_DATABASE.operation
      ] || []),
    ];
  }, [equipmentType, attachmentType, operationType, isHoistSelected]);

  // Prevent server/client layout or ID mismatches
  if (!isMounted) {
    return (
  ...
  const addToBatch = () => {
    if (!inspectorName || !customerName || !assetName) {
      setFeedback({
        type: 'error',
        message: 'Inspector, Customer, and Asset Name are required.',
      });
      return;
    }
    ...
    if (incomplete) {
      setFeedback({
        type: 'error',
        message: 'Please complete all checklist items for this unit.',
      });
      return;
    }
    ...
    const checklistSummary = currentQuestions
      .map((q) => {
        const res = responses[q.id];
        return `${q.question} [${res?.status || 'Pass'}]: ${
          res?.notes || 'No notes'
        }`;
      })
      .join(' | ');
    ...
    if (editingId) {
      setBatch((prev) =>
        prev.map((item) =>
          item.id === editingId ? { ...entryData, id: editingId } : item
        )
      );
      ...
      setFeedback({
        type: 'success',
        message: 'Equipment added to batch successfully!',
      });
    }
  ...
  const submitFullBatch = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        setFeedback({
          type: 'success',
          message: `Batch ${batchId} submitted successfully!`,
        });
        setBatch([]);
        setBatchId(generateBatchId());
        clearForm();
      ...
      setFeedback({
        type: 'error',
        message: 'Failed to submit batch. Data remains in session.',
      });
      setSubmitting(false);
    }
  };
    ...
    <div className="min-h-screen bg-slate-100 text-slate-900 font-sans p-4 md:p-8 pb-32">
      <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold tracking-tight uppercase">
                  Batch Safety Inspection
                </h1>
                <p className="text-blue-100 text-sm opacity-90">
                  OSHA 1910.179 / ASME B30
                </p>
              </div>
            </div>
            <div className="flex flex-col md:items-end bg-blue-800/40 p-3 rounded-xl border border-blue-500/30">
              <span className="text-[10px] uppercase font-bold text-blue-200 tracking-widest">
                Active Batch ID
              </span>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              {batch.length > 0 && (
                <p className="text-[10px] text-blue-600 font-medium ml-1 italic">
                  Customer locked for current batch
                </p>
              )}
            </div>
            <div className="space-y-2">
        ...
        >
          <div
            className={`${
              editingId ? 'bg-orange-50' : 'bg-slate-50'
            } border-b border-slate-200 p-4 px-6 flex justify-between items-center transition-colors`}
          >
          ...
          <div className="p-6 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                >
                  {Object.keys(CHECKLIST_DATABASE.equipment).map((t) => (
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-2 py-2 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm"
                >
                  {Object.keys(CHECKLIST_DATABASE.attachment).map((t) => (
                    <option key={t}>{t}</option>
                  ))}
                </select>
              </div>
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-2 py-2 bg-white border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-sm"
                >
                  {Object.keys(CHECKLIST_DATABASE.operation).map((t) => (
                    <option key={t}>{t}</option>
                  ))}
                </select>
              </div>
            ...
            {!isHoistSelected && (
              <div className="bg-blue-50 border border-blue-100 p-3 rounded-xl flex items-center gap-3 text-blue-700 text-xs font-medium">
                ...
                <span>
                  Configured without lifting media. Hooks and Wire Rope/Chain
                  checks are hidden.
                </span>
              </div>
            )}
            ...
            <div className="space-y-4 pt-4 border-t border-slate-100">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-bold text-slate-800 uppercase flex items-center gap-2">
                  <ListChecks className="w-4 h-4 text-blue-600" /> Dynamic
                  Checklist
                </h3>
              ...
              <div className="grid grid-cols-1 gap-3">
                {currentQuestions.map((q, idx) => (
                  <div
                    key={q.id}
                    className="p-4 border border-slate-100 bg-slate-50/30 rounded-xl space-y-3 transition-all hover:border-slate-200"
                  >
                    <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
                      <p className="text-sm font-semibold text-slate-700 leading-tight">
                        <span className="text-slate-300 font-mono text-xs mr-2">
                          {idx + 1}.
                        </span>
                        {q.question}
                      </p>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        handleResponseChange(q.id, undefined, e.target.value)
                      }
                    />
                  </div>
                ))}
            ...
            <div className="flex items-center gap-3 text-white">
              ...
              <div>
                <h2 className="font-bold uppercase tracking-widest text-sm">
                  Inspection Batch Summary
                </h2>
                <p className="text-[10px] text-slate-400 font-medium">
                  Click a unit to reopen/edit
                </p>
              </div>
            </div>
          ...
          <div className="p-6">
            {batch.length === 0 ? (
              <div className="py-16 text-center border-2 border-dashed border-slate-700 rounded-2xl">
                ...
                <p className="text-slate-500 text-sm italic max-w-xs mx-auto">
                  No units staged yet. Use the form above to add inspections to
                  this batch.
                </p>
              </div>
            ) : (
                ...
                {batch.map((item, i) => (
                  ...
                  >
                    <div className="flex items-center gap-4 min-w-0">
                      <div
                        className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-[10px] font-black border transition-colors ${
                          editingId === item.id
            ...
            <div className="mt-8 pt-6 border-t border-slate-700 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex-1 max-w-md w-full">
                {feedback && (
                  <div
                    className={`p-4 rounded-xl flex items-center gap-3 animate-in slide-in-from-left-4 ${
        ...
        <p className="text-center text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] pb-10">
          Industrial Safety Engine &bull; {new Date().getFullYear()}
        </p>
      </div>
    </div>
  );
